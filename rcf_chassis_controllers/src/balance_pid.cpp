...
#include "rcf_chassis_controllers/balance_pid.h"

#include <tf2/utils.h>

#include <pluginlib/class_list_macros.hpp>

#include "rcf_common/math_utilities.h"
...
bool BalancePidController::init(hardware_interface::RobotHW *robot_hw, ros::NodeHandle &root_nh,
  ...
  velocity_filter_ = new rcf_filters::LowPassFilter<double>(0.3);
  return true;
}
...
PLUGINLIB_EXPORT_CLASS(rcf_chassis_controllers::BalancePidController, controller_interface::ControllerBase)
